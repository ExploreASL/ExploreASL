...
%% 2) Fill NaNs at edges y_T1.nii flowfield to prevent interpolation artifact
xASL_im_FillNaNs(x.P.Path_y_T1, 4, x.settings.Quality); % First fill NaNs, to prevent interpolation artifacts
...
%% 4) Fill NaNs at edges y_ASL.nii
xASL_im_FillNaNs(x.P.Path_y_ASL, 4); % Again fill NaNs, if needed
