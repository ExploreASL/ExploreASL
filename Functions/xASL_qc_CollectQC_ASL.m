...
% Copyright (C) 2015-2019 ExploreASL
    ...
    if xASL_exist(x.P.Path_MaskVascular)
    ...
    ASL.CBF_GM_Median_mL100gmin = xASL_stat_ComputeMean(CBFmasked,[],[],0, GMmasked, WMmasked);
    [ASL.CBF_GM_PVC2_mL100gmin, ASL.CBF_WM_PVC2_mL100gmin] = xASL_stat_ComputeMean(CBFmasked,[],[],2, GMmasked, WMmasked);
