...
[jsonIn,jsonOut] = xASL_bids_BIDSifyASLJSON_checkTimeEncoded(jsonIn,jsonOut);
...
function [jsonIn,jsonOut] = xASL_bids_BIDSifyASLJSON_checkTimeEncoded(jsonIn,jsonOut)
