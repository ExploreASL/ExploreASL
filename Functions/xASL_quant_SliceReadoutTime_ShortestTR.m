...
% Copyright 2015-2020 ExploreASL
    ...
    elseif min(x.Q.SliceReadoutTime)<10 || max(x.Q.SliceReadoutTime)>200
        warning(['qnt_PLDslicereadout=' num2str(x.Q.SliceReadoutTime) ' is outside of its valid range 10-200 ms']);
    end
