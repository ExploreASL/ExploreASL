...
bidsPar.listFieldsRemoveGeneral = {'ProcedureStepDescription' 'SeriesDescription' 'ProtocolName'... % Anonymization
	...
	'SaturationStopTime','BaseResolution','DerivedVendorReportedEchoSpacing','RawImage', 'T1', 'PercentSampling', 'ImageOrientationText', 'PhaseOversampling','BolusDuration','scaleFactor','EchoNumber','BidsGuess'}; % Fields to exclude as not defined in BIDS
...
bidsPar.listFieldsRemoveASL = {'SliceReadoutTime','RepetitionTime','InversionTime','LabelOffset','PostLabelDelay','NumRFBlocks', 'GELabelingDuration','RFGap','MeanGzx10','PhiAdjust','M0','LabelingType',...
	...
	'TagPlaneSNormalDTra' 'Tag0', 'RepetitionTimePreparationM0', 'PostLabelingDelay_1'};
