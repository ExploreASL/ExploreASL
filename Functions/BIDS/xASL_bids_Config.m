...
bidsPar.listFieldOrder = {'Manufacturer','ManufacturersModelName','DeviceSerialNumber','StationName','SoftwareVersions','HardcopyDeviceSoftwareVersion',...%BIDS fields
			  ...
			  'PartialFourierDirection','PhaseEncodingDirection','EffectiveEchoSpacing','EstimatedEffectiveEchoSpacing','TotalReadoutTime','EstimatedTotalReadoutTime','EchoTime','MixingTime','InversionTime',...
