...
bidsPar.listFieldOrder = {'Manufacturer','ManufacturersModelName','DeviceSerialNumber','StationName','SoftwareVersions','HardcopyDeviceSoftwareVersion',...%BIDS fields
			  ...
			  'RepetitionTime','VolumeTiming','RepetitionTimePreparation','TaskName','Units',... % And ASL-BIDS fields
			  'ArterialSpinLabelingType','PostLabelingDelay','BackgroundSuppression','VascularCrushing','AcquisitionVoxelSize',...
			  'TotalAcquiredVolumes',...
			  'BackgroundSuppressionNumberPulses','BackgroundSuppressionPulseTime','M0Type','M0Estimate','VascularCrushingVenc','LabelingLocationDescription',...
