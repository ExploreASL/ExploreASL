...
bidsPar.listFieldsRemoveGeneral = {'ProcedureStepDescription' 'SeriesDescription' 'ProtocolName'... % Anonymization
	...
	'SaturationStopTime','BaseResolution','DerivedVendorReportedEchoSpacing','RawImage','PhaseOversampling','BolusDuration','scaleFactor'}; % Fields to exclude as not defined in BIDS
