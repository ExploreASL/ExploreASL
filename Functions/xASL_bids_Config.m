...
bidsPar.listFieldsRemoveGeneral = {'ProcedureStepDescription' 'SeriesDescription' 'ProtocolName'... % Anonymization
	...
	'EchoTrainLength','PhaseEncodingSteps','BodyPartExamined','ShimSetting','TxRefAmp','PhaseResolution','InstanceNumber',...
...
bidsPar.listFieldOrder = {'Manufacturer','ManufacturersModelName','DeviceSerialNumber','StationName','SoftwareVersions','HardcopyDeviceSoftwareVersion',...%BIDS fields
			  ...
			  'NonlinearGradientCorrection','MRAcquisitionType',...
			  'NumberShots','ParallelReductionFactorInPlane','ParallellAcquisitionTechnique','PartialFourier',...
			  'PartialFourierDirection','PhaseEncodingDirection','EffectiveEchoSpacing','TotalReadoutTime','EchoTime','InversionTime','SliceTiming',...
			  'SliceEncodingDirection','DwellTime','FlipAngle','NegativeContrast','MultibandAccelerationFactor','AnatomicalLandmarkCoordinates',...
