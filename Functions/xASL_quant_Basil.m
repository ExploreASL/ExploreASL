...
if ~x.ApplyQuantification(3)
    ...
    fprintf(optionFile, '# Basil options written by ExploreASL\n');
    fprintf(optionFile, '--repeats=%i\n', size(PWI, 4));
    fprintf(optionFile, '--ti1=%f\n', (x.Q.LabelingDuration + x.Q.Initial_PLD)/1000);
    fprintf(optionFile, '--t1b=%f\n', x.Q.BloodT1/1000);
    fprintf(optionFile, '--tau=%f\n', x.Q.LabelingDuration/1000); % FIXME tau could be list
    fprintf(optionFile, '--slicedt=%f\n', x.Q.SliceReadoutTime/1000);
    fprintf(optionFile, '--save-model-fit\n');
    ...
    fprintf(optionFile, '--allow-bad-voxels\n');
    ...
    switch x.Q.nCompartments
        case 1
            fprintf(optionFile, '--bat=0\n');
            fprintf(optionFile, '--t1=%f\n', x.Q.BloodT1/1000);
            fprintf('Basil: Single-compartment (white paper mode)\n');
        case 2
            fprintf(optionFile, '--bat=%f\n', x.Q.ATT/1000);
            fprintf(optionFile, '--t1=%f\n', x.Q.TissueT1/1000);
    ...
    if isfield(x.Q,'BasilInferATT') && x.Q.BasilInferATT
        ...
        fprintf(optionFile, '--inferbat\n');
        fprintf(optionFile, '--batsd=%f\n', x.Q.BasilATTSD);
    ...
    if isfield(x.Q,'BasilNoisePrior') && x.Q.BasilNoisePrior
        ...
        fprintf(optionFile, '--prior-noise-stddev=%f\n', x.Q.BasilNoiseSD);
    end
