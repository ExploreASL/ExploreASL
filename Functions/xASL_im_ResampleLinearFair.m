...
if newsize(1)~=size(im_input,1) && newsize(2)~=size(im_input,2) && newsize(3)~=size(im_input,3)
    output_res = xASL_im_ResampleLinearFair_3D(im_input,newsize,old_res,new_res);
elseif newsize(1)==size(im_input,1) && newsize(2)==size(im_input,2) && newsize(3)~=size(im_input,3)
    output_res = xASL_im_ResampleLinearFair_1D_3(im_input,newsize,old_res,new_res);
elseif newsize(1)==size(im_input,1) && newsize(2)~=size(im_input,2) && newsize(3)==size(im_input,3)
    output_res = xASL_im_ResampleLinearFair_1D_2(im_input,newsize,old_res,new_res);
elseif newsize(1)~=size(im_input,1) && newsize(2)==size(im_input,2) && newsize(3)==size(im_input,3)
    output_res = xASL_im_ResampleLinearFair_1D_1(im_input,newsize,old_res,new_res);
else 
...
function output_res = xASL_im_ResampleLinearFair_3D(im_input,newsize,old_res,new_res)
fprintf('Resample:    ');
...
function output_res = xASL_im_ResampleLinearFair_1D_3(im_input,newsize,old_res,new_res)
...
function output_res = xASL_im_ResampleLinearFair_1D_2(im_input,newsize,old_res,new_res)
...
function output_res = xASL_im_ResampleLinearFair_1D_1(im_input,newsize,old_res,new_res)
