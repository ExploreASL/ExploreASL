...
%xASL_im_CropParmsApply Crops 2D image data
%
% FORMAT: ImageOut = xASL_im_CropParmsApply(ImageIn,CropParameters)
%
% INPUT:
...
%         ImageOut = xASL_im_CropParmsApply(ImageIn,[12 133 0 121])
