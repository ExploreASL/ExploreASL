...
try
    ...
    NativeSpaceFiles{2} = {'.*\.topup.*log' '.*FSL.*' 'WADQC.*\.json' '.*(rep_|BeforeSpikeExclusion|despiked).*' '(VascularArtifact|xASL_qc|qcdc).*' 'rp_ASL4D\.txt' '(ASL4D|M0|.*_sn)\.mat'...
        ...
        '(SliceGradient(_extrapolated|)|BrainMaskProcessing|ABV|ATT|Tex|ITT|slice_gradient|rgrey|wASL4D|PWI|PWI3D|PWI4D|y_ASL|Pseudo(CBF|Tissue)|rM0|Field|Unwarped|rASL4D)(\.json|\.mat|\.nii|\.nii\.gz)$'...
