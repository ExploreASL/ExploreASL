...
% Copyright 2015-2021 ExploreASL
    ...
    for iT=1:x.dataset.nTimePointsTotal
        fprintf('%s\n',['Longitudinal timePoint ' num2str(iT) ' = ' num2str(x.dataset.nTimePointTotalSubjects(iT)) ' scans - ' num2str(x.nTimePointExcluded(iT)) ' exclusions = ' num2str(x.nTimePointSubjects(iT)) ' scans']);
    end
