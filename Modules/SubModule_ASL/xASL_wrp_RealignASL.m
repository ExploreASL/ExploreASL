...
if nFrames>2 && bSubtraction && (numel(unique(x.Q.Initial_PLD))>1 || numel(unique(x.EchoTime))>1 || isfield(x.modules.asl,'TimeEncodedMatrixType') %multiPLD or multiTE or Hadamard
