...
xASL_adm_CreatePopulationDirs(x);
...
% Start mutex locking process to ensure that everything will run only once
x = xASL_init_InitializeMutex(x, 'QC');
...
function [fixedPopDir,conditionalPopDirs] = xASL_adm_CreatePopulationDirs(x)
    ...
    conditionalPopDirs =  { x.D.T1CheckDir, ...
                            x.D.CoregDir, ...
                            x.D.FLAIR_CheckDir, ...
                            x.D.T1c_CheckDir, ...
                            x.D.T2_CheckDir, ...
