...
List2CheckNativeSpace = {x.P.Path_T1     , x.P.Path_T1,       x.P.Path_T2,     x.P.Path_T1c};   % Source path
List2Check =            {x.P.Pop_Path_PV_pGM x.P.Pop_Path_PV_pWM  x.P.Pop_Path_rT2 x.P.Pop_Path_rT1c}; % Population path
