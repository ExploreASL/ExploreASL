%xASL_wrp_FLAIR_BiasfieldCorrection_test Script to test the xASL_wrp_FLAIR_BiasfieldCorrection function
%
% FORMAT:       RESULT = runtests('xASL_wrp_FLAIR_BiasfieldCorrection_test');
% 
% INPUT:        None
%
...
% 
% -----------------------------------------------------------------------------------------------------------------------------------------------------
% DESCRIPTION: This script is supposed to run various unit tests of xASL_wrp_FLAIR_BiasfieldCorrection:
%
%           1) Run a test using the default TestDataSet inputs with low quality setting
%
% -----------------------------------------------------------------------------------------------------------------------------------------------------
% EXAMPLES: RESULT = runtests('xASL_wrp_FLAIR_BiasfieldCorrection_test');
