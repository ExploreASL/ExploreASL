		...
		switch(fList{ii})
			...
			case 'Siemens_PCASL_multiTI'
				...
				if xASL_exist([baseDirImport '/Siemens_PCASL_multiTI/analysis/Sub1/ASL_1/ASL4D_NS_300.nii'])
					...
					for jj = 1:length(mTIvec)
						xASL_delete(fullfile([baseDirImport '/Siemens_PCASL_multiTI/analysis/Sub1/ASL_1/ASL4D_NS_' xASL_num2str(mTIvec(jj)) '.nii']));
						xASL_delete(fullfile([baseDirImport '/Siemens_PCASL_multiTI/analysis/Sub1/ASL_1/ASL4D_SS_' xASL_num2str(mTIvec(jj)) '.nii']));
					end
				end
				ExploreASL_ImportBIDS(fullfile(baseDirImport,fList{ii}), [],[], [0 1 0], false, true, false, false);
