function UnitTest = xASL_ut_UnitTest_function_CreateDatasetDescriptionTemplate(TestRepository)
%xASL_ut_UnitTest_function_CreateDatasetDescriptionTemplate Individual unit test for xASL_bids_CreateDatasetDescriptionTemplate
%
...
%
% EXAMPLE:      UnitTests(1) = xASL_ut_UnitTest_function_CreateDatasetDescriptionTemplate(TestRepository);
% -----------------------------------------------------------------------------------------------------------------------------------------------------
...
UnitTest.name = 'xASL_bids_CreateDatasetDescriptionTemplate';
