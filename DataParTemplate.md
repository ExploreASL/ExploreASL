...
| x.Q.Manufacturer                      | String containing the Manufacturer used. This parameter is used to apply the Manufacturer-specific scale factors (REQUIRED for ASL), options: 'GE_product', 'GE_WIP', 'Philips', 'Siemens'. |  |
