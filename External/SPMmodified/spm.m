...
% spm('AsciiWelcome')
disp( ' ___  ____  __  __                                            ');
disp( '/ __)(  _ \(  \/  )  modified xASL version                    ');
...
%-----------------------------------------------------------------------
% if ~isdeployed %% EXPLOREASL HACK TO AVOID WARNING
...
CmdLine = true; % EXPLOREASL FIX, force CmdLine output
CmdLine2 = true; % EXPLOREASL FIX, force CmdLine output
