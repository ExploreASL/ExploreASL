...
function [TI,T3th,T3r] = cat_vol_CGWscale(T,G,B,Gth,vx_vol)
  ...
  % Nun k�nnen wir uns die Kannte zum GM anschauen, die sich in D<2 zum 
  % knapp unterhalb des WM. Da diese beide Seiten gleichartig betrifft, 
  % sollte man so recht gut den GWM peak bestimmen k�nnen. Das da teil-
  ...
  % meist zu wenig CSF als das man damit was machen k�nne, weshalb die
  % Absch�tzung des CSFs �ber den GM Wert dann schon wieder besser ist.
  T3th(3) = T7th(6);
  T3th(2) = T7th(4);
