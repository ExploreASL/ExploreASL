function [job1, job2] = ps_LST_lpa_preproc_default_UltraLowQ

job1.channel.biasreg = 0;
job1.channel.biasfwhm = Inf;
...
job2.eoptions.sep = [16];
job2.eoptions.tol = [0.02];
