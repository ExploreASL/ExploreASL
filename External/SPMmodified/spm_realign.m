function P = spm_realign(P,flags,bZigzag)
...
% The third input parameter bZigzag defines if the Ze Wang's version is executed, or if the original version
...
% FORMAT P = spm_realign(P,flags,bZigzag)
%
...
%                    default: ~spm('CmdLine')
% 
% bZigzag          - run Zig-zag version if TRUE, run normal SPM version if FALSE (DEFAULT FALSE)
...
if bZigzag
	if isfield(flags,'ctrfirst')
		ctrfirst=flags.ctrfirst;
	else
		ctrfirst=0;
	end
end
...
M  = xASL_round(inv(M2) * inv(spm_matrix(p)) * M1,12);   %ExploreASL fix to remove between software variability
...
%==========================================================================
% function cleanandsave_parameters(V)
%==========================================================================
