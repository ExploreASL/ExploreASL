...
then
	...
	/mnt/c/Program\ Files/MATLAB/R2014a/bin/matlab.exe -nodesktop -nosplash -r "ExploreASL_Master('c:\Backup\OtherToolboxesEtc\ExploreASL_Repro\ExploreASL\TestDataSet_Win2014a\DATA_PAR.m', true, true);exit"
	/mnt/c/Program\ Files/MATLAB/R2011a/bin/matlab.exe -nodesktop -nosplash -r "ExploreASL_Master('c:\Backup\OtherToolboxesEtc\ExploreASL_Repro\ExploreASL\TestDataSet_Win2011a\DATA_PAR.m', true, true);exit"	
	
else
	echo "Creating & running TestDataSet_Processed"
	cp -rf ./TestDataSet ./TestDataSet_Processed
	/mnt/c/Program\ Files/MATLAB/R2018b/bin/matlab.exe -nodesktop -nosplash -r "ExploreASL_Master('c:\Backup\OtherToolboxesEtc\ExploreASL_Repro\ExploreASL\TestDataSet_Processed\DATA_PAR.m', true, true);exit"
fi
