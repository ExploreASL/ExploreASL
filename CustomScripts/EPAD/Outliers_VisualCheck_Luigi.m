...
for iValue = 1:3
    for iS = 2:3
        if startsWith(Parameter, 'Structural') && exist(T1_files{iValue,iS}, 'file')
            T1im = xASL_vis_CreateVisualFig(x, T1_files{iValue,iS}); Flairim = xASL_vis_CreateVisualFig(x, Flair_files{iValue,iS});
        ...
        elseif startsWith(Parameter, 'func') && exist(Func_files{iValue,iS}, 'file')
            boldIm = xASL_vis_CreateVisualFig(x, Func_files{iValue,iS}) ; %SDIm = xASL_vis_CreateVisualFig(x, Func_SD_files{iValue,iS});
        ...
        elseif startsWith(Parameter, 'dwi') && exist(DWI_files{iValue,iS}, 'file')
            dwiIm = xASL_vis_CreateVisualFig(x, DWI_files{iValue,iS}) ;
            dwiIm = fliplr(dwiIm);
...
%        elseif startsWith(Parameter, 'ASL') && exist(ASL_files{iValue,iS}, 'file')
           % aslIm = xASL_vis_CreateVisualFig(x, ASL_files{iValue,iS});
            %aslIm = fliplr(aslIm);
