...
for ii=1:length(nameTPM)
	...
	% Copy normal files
	listFile = {'Total.tsv' 'WholeBrain.tsv' 'MNI_Structural.tsv' 'LeftRight.tsv' 'LabelColors.mat' 'GhostSignalRatio.tsv' 'DeepWM.tsv' 'Identity_sn.mat' 'Identity_Deformation_y_T1.nii.gz'...
